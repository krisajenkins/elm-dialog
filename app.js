...
Elm.Heroes.Batman = Elm.Heroes.Batman || {};
Elm.Heroes.Batman.Types = Elm.Heroes.Batman.Types || {};
Elm.Heroes.Batman.Types.make = function (_elm) {
   "use strict";
   _elm.Heroes = _elm.Heroes || {};
   _elm.Heroes.Batman = _elm.Heroes.Batman || {};
   _elm.Heroes.Batman.Types = _elm.Heroes.Batman.Types || {};
   if (_elm.Heroes.Batman.Types.values) return _elm.Heroes.Batman.Types.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var Model = F2(function (a,b) {    return {kapows: a,showModal: b};});
   return _elm.Heroes.Batman.Types.values = {_op: _op,Model: Model,Kapow: Kapow,Finished: Finished};
};
Elm.Heroes = Elm.Heroes || {};
Elm.Heroes.Superman = Elm.Heroes.Superman || {};
Elm.Heroes.Superman.Types = Elm.Heroes.Superman.Types || {};
Elm.Heroes.Superman.Types.make = function (_elm) {
   "use strict";
   _elm.Heroes = _elm.Heroes || {};
   _elm.Heroes.Superman = _elm.Heroes.Superman || {};
   _elm.Heroes.Superman.Types = _elm.Heroes.Superman.Types || {};
   if (_elm.Heroes.Superman.Types.values) return _elm.Heroes.Superman.Types.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   return _elm.Heroes.Superman.Types.values = {_op: _op,Model: Model,Punch: Punch};
};
Elm.Heroes = Elm.Heroes || {};
Elm.Heroes.WonderWoman = Elm.Heroes.WonderWoman || {};
Elm.Heroes.WonderWoman.Types = Elm.Heroes.WonderWoman.Types || {};
Elm.Heroes.WonderWoman.Types.make = function (_elm) {
   "use strict";
   _elm.Heroes = _elm.Heroes || {};
   _elm.Heroes.WonderWoman = _elm.Heroes.WonderWoman || {};
   _elm.Heroes.WonderWoman.Types = _elm.Heroes.WonderWoman.Types || {};
   if (_elm.Heroes.WonderWoman.Types.values) return _elm.Heroes.WonderWoman.Types.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   return _elm.Heroes.WonderWoman.Types.values = {_op: _op,Model: Model,Swipe: Swipe};
};
Elm.Heroes = Elm.Heroes || {};
Elm.Heroes.Types = Elm.Heroes.Types || {};
Elm.Heroes.Types.make = function (_elm) {
   "use strict";
   _elm.Heroes = _elm.Heroes || {};
   _elm.Heroes.Types = _elm.Heroes.Types || {};
   if (_elm.Heroes.Types.values) return _elm.Heroes.Types.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Heroes$Batman$Types = Elm.Heroes.Batman.Types.make(_elm),
   $Heroes$Superman$Types = Elm.Heroes.Superman.Types.make(_elm),
   $Heroes$WonderWoman$Types = Elm.Heroes.WonderWoman.Types.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   ...
   return _elm.Heroes.Types.values = {_op: _op
                                     ,Model: Model
...
Elm.Villains = Elm.Villains || {};
Elm.Villains.Joker = Elm.Villains.Joker || {};
Elm.Villains.Joker.Types = Elm.Villains.Joker.Types || {};
Elm.Villains.Joker.Types.make = function (_elm) {
   "use strict";
   _elm.Villains = _elm.Villains || {};
   _elm.Villains.Joker = _elm.Villains.Joker || {};
   _elm.Villains.Joker.Types = _elm.Villains.Joker.Types || {};
   if (_elm.Villains.Joker.Types.values) return _elm.Villains.Joker.Types.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var Model = function (a) {    return {shots: a};};
   return _elm.Villains.Joker.Types.values = {_op: _op,Model: Model,Shoot: Shoot};
};
Elm.Villains = Elm.Villains || {};
Elm.Villains.Penguin = Elm.Villains.Penguin || {};
Elm.Villains.Penguin.Types = Elm.Villains.Penguin.Types || {};
Elm.Villains.Penguin.Types.make = function (_elm) {
   "use strict";
   _elm.Villains = _elm.Villains || {};
   _elm.Villains.Penguin = _elm.Villains.Penguin || {};
   _elm.Villains.Penguin.Types = _elm.Villains.Penguin.Types || {};
   if (_elm.Villains.Penguin.Types.values) return _elm.Villains.Penguin.Types.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var Wark = {ctor: "Wark"};
   var Model = F2(function (a,b) {    return {warks: a,quiet: b};});
   return _elm.Villains.Penguin.Types.values = {_op: _op,Model: Model,Wark: Wark,Close: Close};
};
Elm.Villains = Elm.Villains || {};
Elm.Villains.Types = Elm.Villains.Types || {};
Elm.Villains.Types.make = function (_elm) {
   "use strict";
   _elm.Villains = _elm.Villains || {};
   _elm.Villains.Types = _elm.Villains.Types || {};
   if (_elm.Villains.Types.values) return _elm.Villains.Types.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Villains$Joker$Types = Elm.Villains.Joker.Types.make(_elm),
   $Villains$Penguin$Types = Elm.Villains.Penguin.Types.make(_elm);
   var _op = {};
   var SetView = function (a) {    return {ctor: "SetView",_0: a};};
   ...
   return _elm.Villains.Types.values = {_op: _op
                                       ,Model: Model
                                       ,JokerView: JokerView
...
Elm.Types.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Heroes$Types = Elm.Heroes.Types.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Villains$Types = Elm.Villains.Types.make(_elm);
   var _op = {};
   ...
   return _elm.Types.values = {_op: _op,HeroesAction: HeroesAction,VillainsAction: VillainsAction,Model: Model};
};
Elm.Heroes = Elm.Heroes || {};
Elm.Heroes.Batman = Elm.Heroes.Batman || {};
Elm.Heroes.Batman.State = Elm.Heroes.Batman.State || {};
Elm.Heroes.Batman.State.make = function (_elm) {
   "use strict";
   _elm.Heroes = _elm.Heroes || {};
   _elm.Heroes.Batman = _elm.Heroes.Batman || {};
   _elm.Heroes.Batman.State = _elm.Heroes.Batman.State || {};
   if (_elm.Heroes.Batman.State.values) return _elm.Heroes.Batman.State.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Heroes$Batman$Types = Elm.Heroes.Batman.Types.make(_elm),
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "Kapow") {
            return $Response.withNone(_U.update(model,{kapows: model.kapows + 2,showModal: true}));
         } else {
            return $Response.withNone(_U.update(model,{showModal: false}));
         }
   });
   var initialModel = {kapows: 1000,showModal: false};
   return _elm.Heroes.Batman.State.values = {_op: _op,initialModel: initialModel,update: update};
};
Elm.Heroes = Elm.Heroes || {};
Elm.Heroes.Superman = Elm.Heroes.Superman || {};
Elm.Heroes.Superman.State = Elm.Heroes.Superman.State || {};
Elm.Heroes.Superman.State.make = function (_elm) {
   "use strict";
   _elm.Heroes = _elm.Heroes || {};
   _elm.Heroes.Superman = _elm.Heroes.Superman || {};
   _elm.Heroes.Superman.State = _elm.Heroes.Superman.State || {};
   if (_elm.Heroes.Superman.State.values) return _elm.Heroes.Superman.State.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Heroes$Superman$Types = Elm.Heroes.Superman.Types.make(_elm),
   ...
   return _elm.Heroes.Superman.State.values = {_op: _op,initialModel: initialModel,update: update};
};
Elm.Heroes = Elm.Heroes || {};
Elm.Heroes.WonderWoman = Elm.Heroes.WonderWoman || {};
Elm.Heroes.WonderWoman.State = Elm.Heroes.WonderWoman.State || {};
Elm.Heroes.WonderWoman.State.make = function (_elm) {
   "use strict";
   _elm.Heroes = _elm.Heroes || {};
   _elm.Heroes.WonderWoman = _elm.Heroes.WonderWoman || {};
   _elm.Heroes.WonderWoman.State = _elm.Heroes.WonderWoman.State || {};
   if (_elm.Heroes.WonderWoman.State.values) return _elm.Heroes.WonderWoman.State.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Heroes$WonderWoman$Types = Elm.Heroes.WonderWoman.Types.make(_elm),
   ...
   return _elm.Heroes.WonderWoman.State.values = {_op: _op,initialModel: initialModel,update: update};
};
Elm.Heroes = Elm.Heroes || {};
Elm.Heroes.State = Elm.Heroes.State || {};
Elm.Heroes.State.make = function (_elm) {
   "use strict";
   _elm.Heroes = _elm.Heroes || {};
   _elm.Heroes.State = _elm.Heroes.State || {};
   if (_elm.Heroes.State.values) return _elm.Heroes.State.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Heroes$Batman$State = Elm.Heroes.Batman.State.make(_elm),
   $Heroes$Superman$State = Elm.Heroes.Superman.State.make(_elm),
   $Heroes$Types = Elm.Heroes.Types.make(_elm),
   $Heroes$WonderWoman$State = Elm.Heroes.WonderWoman.State.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Response = Elm.Response.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   var update = F2(function (action,model) {
      ...
      {case "SetView": return $Response.withNone(_U.update(model,{view: _p0._0}));
         case "BatmanAction": return A3($Response.mapBoth,
           ...
           $Heroes$Types.BatmanAction,
           A2($Heroes$Batman$State.update,_p0._0,model.batman));
         case "SupermanAction": return A3($Response.mapBoth,
           function (x) {
              return _U.update(model,{superman: x});
           },
           $Heroes$Types.SupermanAction,
           A2($Heroes$Superman$State.update,_p0._0,model.superman));
         default: return A3($Response.mapBoth,
           function (x) {
              return _U.update(model,{wonderWoman: x});
           },
           $Heroes$Types.WonderWomanAction,
           A2($Heroes$WonderWoman$State.update,_p0._0,model.wonderWoman));}
   });
   var initialModel = {batman: $Heroes$Batman$State.initialModel
                      ,superman: $Heroes$Superman$State.initialModel
                      ,wonderWoman: $Heroes$WonderWoman$State.initialModel
                      ,view: $Heroes$Types.BatmanView};
   return _elm.Heroes.State.values = {_op: _op,initialModel: initialModel,update: update};
};
Elm.Villains = Elm.Villains || {};
Elm.Villains.Joker = Elm.Villains.Joker || {};
Elm.Villains.Joker.State = Elm.Villains.Joker.State || {};
Elm.Villains.Joker.State.make = function (_elm) {
   "use strict";
   _elm.Villains = _elm.Villains || {};
   _elm.Villains.Joker = _elm.Villains.Joker || {};
   _elm.Villains.Joker.State = _elm.Villains.Joker.State || {};
   if (_elm.Villains.Joker.State.values) return _elm.Villains.Joker.State.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Villains$Joker$Types = Elm.Villains.Joker.Types.make(_elm);
   var _op = {};
   var update = F2(function (action,model) {    var _p0 = action;return $Response.withNone(_U.update(model,{shots: model.shots + 1}));});
   var initialModel = {shots: 0};
   return _elm.Villains.Joker.State.values = {_op: _op,initialModel: initialModel,update: update};
};
Elm.Villains = Elm.Villains || {};
Elm.Villains.Penguin = Elm.Villains.Penguin || {};
Elm.Villains.Penguin.State = Elm.Villains.Penguin.State || {};
Elm.Villains.Penguin.State.make = function (_elm) {
   "use strict";
   _elm.Villains = _elm.Villains || {};
   _elm.Villains.Penguin = _elm.Villains.Penguin || {};
   _elm.Villains.Penguin.State = _elm.Villains.Penguin.State || {};
   if (_elm.Villains.Penguin.State.values) return _elm.Villains.Penguin.State.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "Wark") {
            return $Response.withNone(_U.update(model,{warks: model.warks + 3,quiet: false}));
         } else {
            return $Response.withNone(_U.update(model,{quiet: true}));
         }
   });
   var initialModel = {warks: 0,quiet: true};
   return _elm.Villains.Penguin.State.values = {_op: _op,initialModel: initialModel,update: update};
};
Elm.Villains = Elm.Villains || {};
Elm.Villains.State = Elm.Villains.State || {};
Elm.Villains.State.make = function (_elm) {
   "use strict";
   _elm.Villains = _elm.Villains || {};
   _elm.Villains.State = _elm.Villains.State || {};
   if (_elm.Villains.State.values) return _elm.Villains.State.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Villains$Joker$State = Elm.Villains.Joker.State.make(_elm),
   $Villains$Penguin$State = Elm.Villains.Penguin.State.make(_elm),
   $Villains$Types = Elm.Villains.Types.make(_elm);
   var _op = {};
   var update = F2(function (action,model) {
      var _p0 = action;
      ...
      {case "SetView": return $Response.withNone(_U.update(model,{view: _p0._0}));
         case "JokerAction": return A3($Response.mapBoth,
           ...
           $Villains$Types.JokerAction,
           A2($Villains$Joker$State.update,_p0._0,model.joker));
         default: return A3($Response.mapBoth,
           function (x) {
              return _U.update(model,{penguin: x});
           },
           $Villains$Types.PenguinAction,
           A2($Villains$Penguin$State.update,_p0._0,model.penguin));}
   });
   var initialModel = {joker: $Villains$Joker$State.initialModel,penguin: $Villains$Penguin$State.initialModel,view: $Villains$Types.JokerView};
   return _elm.Villains.State.values = {_op: _op,initialModel: initialModel,update: update};
};
Elm.State = Elm.State || {};
Elm.State.make = function (_elm) {
   ...
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Heroes$State = Elm.Heroes.State.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Response = Elm.Response.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   $Villains$State = Elm.Villains.State.make(_elm);
   var _op = {};
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "HeroesAction") {
            return A3($Response.mapBoth,
            function (x) {
               return _U.update(model,{heroes: x});
            },
            $Types.HeroesAction,
            A2($Heroes$State.update,_p0._0,model.heroes));
         } else {
            return A3($Response.mapBoth,
            function (x) {
               return _U.update(model,{villains: x});
            },
            $Types.VillainsAction,
            A2($Villains$State.update,_p0._0,model.villains));
         }
   });
   var initialEffects = $Effects.none;
   var initialModel = {heroes: $Heroes$State.initialModel,villains: $Villains$State.initialModel};
   return _elm.State.values = {_op: _op,initialModel: initialModel,initialEffects: initialEffects,update: update};
};
Elm.Viscose = Elm.Viscose || {};
Elm.Viscose.make = function (_elm) {
   "use strict";
   _elm.Viscose = _elm.Viscose || {};
   if (_elm.Viscose.values) return _elm.Viscose.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var root = function (maybeConfig) {
      var displayed = $Exts$Maybe.isJust(maybeConfig);
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.key("modal")
   ...
   return _elm.Viscose.values = {_op: _op,root: root,Config: Config};
};
Elm.Utils = Elm.Utils || {};
Elm.Utils.make = function (_elm) {
   ...
   return _elm.Utils.values = {_op: _op,both: both,actionButton: actionButton};
};
Elm.Heroes = Elm.Heroes || {};
Elm.Heroes.Batman = Elm.Heroes.Batman || {};
Elm.Heroes.Batman.View = Elm.Heroes.Batman.View || {};
Elm.Heroes.Batman.View.make = function (_elm) {
   "use strict";
   _elm.Heroes = _elm.Heroes || {};
   _elm.Heroes.Batman = _elm.Heroes.Batman || {};
   _elm.Heroes.Batman.View = _elm.Heroes.Batman.View || {};
   if (_elm.Heroes.Batman.View.values) return _elm.Heroes.Batman.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Heroes$Batman$Types = Elm.Heroes.Batman.Types.make(_elm),
   ...
   $Viscose = Elm.Viscose.make(_elm);
   var _op = {};
   var modal = F2(function (address,model) {
      return model.showModal ? $Maybe.Just({closeMessage: A2($Signal.message,address,$Heroes$Batman$Types.Finished)
                                           ...
                                           address,
                                           {ctor: "_Tuple2",_0: $Heroes$Batman$Types.Finished,_1: "OK"}))}) : $Maybe.Nothing;
   });
   var root = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Batman")]))
              ,$Html.text($Basics.toString(model))
              ,A2($Utils.actionButton,address,{ctor: "_Tuple2",_0: $Heroes$Batman$Types.Kapow,_1: "Kapow!"})]));
   });
   return _elm.Heroes.Batman.View.values = {_op: _op,root: root,modal: modal};
};
Elm.Heroes = Elm.Heroes || {};
Elm.Heroes.Superman = Elm.Heroes.Superman || {};
Elm.Heroes.Superman.View = Elm.Heroes.Superman.View || {};
Elm.Heroes.Superman.View.make = function (_elm) {
   "use strict";
   _elm.Heroes = _elm.Heroes || {};
   _elm.Heroes.Superman = _elm.Heroes.Superman || {};
   _elm.Heroes.Superman.View = _elm.Heroes.Superman.View || {};
   if (_elm.Heroes.Superman.View.values) return _elm.Heroes.Superman.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Heroes$Superman$Types = Elm.Heroes.Superman.Types.make(_elm),
   ...
   $Viscose = Elm.Viscose.make(_elm);
   var _op = {};
   var modal = F2(function (address,model) {    return $Maybe.Nothing;});
   var root = F2(function (address,model) {
      return A2($Html.div,_U.list([]),_U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Superman")])),$Html.text($Basics.toString(model))]));
   });
   return _elm.Heroes.Superman.View.values = {_op: _op,root: root,modal: modal};
};
Elm.Heroes = Elm.Heroes || {};
Elm.Heroes.WonderWoman = Elm.Heroes.WonderWoman || {};
Elm.Heroes.WonderWoman.View = Elm.Heroes.WonderWoman.View || {};
Elm.Heroes.WonderWoman.View.make = function (_elm) {
   "use strict";
   _elm.Heroes = _elm.Heroes || {};
   _elm.Heroes.WonderWoman = _elm.Heroes.WonderWoman || {};
   _elm.Heroes.WonderWoman.View = _elm.Heroes.WonderWoman.View || {};
   if (_elm.Heroes.WonderWoman.View.values) return _elm.Heroes.WonderWoman.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Heroes$WonderWoman$Types = Elm.Heroes.WonderWoman.Types.make(_elm),
   ...
   var modal = F2(function (address,model) {    return $Maybe.Nothing;});
   var root = F2(function (address,model) {
      return A2($Html.div,_U.list([]),_U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("WonderWoman")])),$Html.text($Basics.toString(model))]));
   });
   return _elm.Heroes.WonderWoman.View.values = {_op: _op,root: root,modal: modal};
};
Elm.Heroes = Elm.Heroes || {};
Elm.Heroes.View = Elm.Heroes.View || {};
Elm.Heroes.View.make = function (_elm) {
   "use strict";
   _elm.Heroes = _elm.Heroes || {};
   _elm.Heroes.View = _elm.Heroes.View || {};
   if (_elm.Heroes.View.values) return _elm.Heroes.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Heroes$Batman$View = Elm.Heroes.Batman.View.make(_elm),
   $Heroes$Superman$View = Elm.Heroes.Superman.View.make(_elm),
   $Heroes$Types = Elm.Heroes.Types.make(_elm),
   $Heroes$WonderWoman$View = Elm.Heroes.WonderWoman.View.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var modal = F2(function (address,model) {
      var _p0 = model.view;
      switch (_p0.ctor)
      {case "BatmanView": return A2($Heroes$Batman$View.modal,A2($Signal.forwardTo,address,$Heroes$Types.BatmanAction),model.batman);
         case "SupermanView": return A2($Heroes$Superman$View.modal,A2($Signal.forwardTo,address,$Heroes$Types.SupermanAction),model.superman);
         default: return A2($Heroes$WonderWoman$View.modal,A2($Signal.forwardTo,address,$Heroes$Types.WonderWomanAction),model.wonderWoman);}
   });
   var root = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Heroes")]))
              ...
              _U.list([function () {
                 var _p1 = model.view;
                 switch (_p1.ctor)
                 {case "BatmanView": return A2($Heroes$Batman$View.root,A2($Signal.forwardTo,address,$Heroes$Types.BatmanAction),model.batman);
                    case "SupermanView": return A2($Heroes$Superman$View.root,A2($Signal.forwardTo,address,$Heroes$Types.SupermanAction),model.superman);
                    default: return A2($Heroes$WonderWoman$View.root,A2($Signal.forwardTo,address,$Heroes$Types.WonderWomanAction),model.wonderWoman);}
              }()]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("btn-group")]),
              A2($List.map,
              $Utils.actionButton(address),
              _U.list([{ctor: "_Tuple2",_0: $Heroes$Types.SetView($Heroes$Types.BatmanView),_1: "Batman"}
                      ,{ctor: "_Tuple2",_0: $Heroes$Types.SetView($Heroes$Types.SupermanView),_1: "Superman"}
                      ,{ctor: "_Tuple2",_0: $Heroes$Types.SetView($Heroes$Types.WonderWomanView),_1: "WonderWoman"}])))]));
   });
   return _elm.Heroes.View.values = {_op: _op,root: root,modal: modal};
};
Elm.Villains = Elm.Villains || {};
Elm.Villains.Joker = Elm.Villains.Joker || {};
Elm.Villains.Joker.View = Elm.Villains.Joker.View || {};
Elm.Villains.Joker.View.make = function (_elm) {
   "use strict";
   _elm.Villains = _elm.Villains || {};
   _elm.Villains.Joker = _elm.Villains.Joker || {};
   _elm.Villains.Joker.View = _elm.Villains.Joker.View || {};
   if (_elm.Villains.Joker.View.values) return _elm.Villains.Joker.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var modal = F2(function (address,model) {    return $Maybe.Nothing;});
   var root = F2(function (address,model) {
      return A2($Html.div,_U.list([]),_U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Joker")])),$Html.text($Basics.toString(model))]));
   });
   return _elm.Villains.Joker.View.values = {_op: _op,root: root,modal: modal};
};
Elm.Villains = Elm.Villains || {};
Elm.Villains.Penguin = Elm.Villains.Penguin || {};
Elm.Villains.Penguin.View = Elm.Villains.Penguin.View || {};
Elm.Villains.Penguin.View.make = function (_elm) {
   "use strict";
   _elm.Villains = _elm.Villains || {};
   _elm.Villains.Penguin = _elm.Villains.Penguin || {};
   _elm.Villains.Penguin.View = _elm.Villains.Penguin.View || {};
   if (_elm.Villains.Penguin.View.values) return _elm.Villains.Penguin.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var _op = {};
   var modal = F2(function (address,model) {
      return model.quiet ? $Maybe.Nothing : $Maybe.Just({closeMessage: A2($Signal.message,address,$Villains$Penguin$Types.Close)
                                                        ,header: $Maybe.Just(A2($Html.h1,_U.list([]),_U.list([$Html.text("Wark!")])))
                                                        ,body: $Maybe.Just($Html.text("The Penguin laughs his weird laugh"))
                                                        ,footer: $Maybe.Just(A2($Utils.actionButton,
                                                        address,
                                                        {ctor: "_Tuple2",_0: $Villains$Penguin$Types.Close,_1: "OK"}))});
   });
   var root = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Penguin")]))
              ,$Html.text($Basics.toString(model))
              ,A2($Utils.actionButton,address,{ctor: "_Tuple2",_0: $Villains$Penguin$Types.Wark,_1: "Wark!"})]));
   });
   return _elm.Villains.Penguin.View.values = {_op: _op,root: root,modal: modal};
};
Elm.Villains = Elm.Villains || {};
Elm.Villains.View = Elm.Villains.View || {};
Elm.Villains.View.make = function (_elm) {
   "use strict";
   _elm.Villains = _elm.Villains || {};
   _elm.Villains.View = _elm.Villains.View || {};
   if (_elm.Villains.View.values) return _elm.Villains.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $Utils = Elm.Utils.make(_elm),
   $Villains$Joker$View = Elm.Villains.Joker.View.make(_elm),
   $Villains$Penguin$View = Elm.Villains.Penguin.View.make(_elm),
   $Villains$Types = Elm.Villains.Types.make(_elm),
   $Viscose = Elm.Viscose.make(_elm);
   var _op = {};
   var modal = F2(function (address,model) {
      ...
      if (_p0.ctor === "JokerView") {
            return A2($Villains$Joker$View.modal,A2($Signal.forwardTo,address,$Villains$Types.JokerAction),model.joker);
         } else {
            return A2($Villains$Penguin$View.modal,A2($Signal.forwardTo,address,$Villains$Types.PenguinAction),model.penguin);
         }
   });
   var root = F2(function (address,model) {
      return A2($Html.div,
      ...
      _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Villains")]))
              ...
              _U.list([function () {
                 ...
                 if (_p1.ctor === "JokerView") {
                       return A2($Villains$Joker$View.root,A2($Signal.forwardTo,address,$Villains$Types.JokerAction),model.joker);
                    } else {
                       return A2($Villains$Penguin$View.root,A2($Signal.forwardTo,address,$Villains$Types.PenguinAction),model.penguin);
                    }
              }()]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("btn-group")]),
              A2($List.map,
              $Utils.actionButton(address),
              _U.list([{ctor: "_Tuple2",_0: $Villains$Types.SetView($Villains$Types.JokerView),_1: "Joker"}
                      ,{ctor: "_Tuple2",_0: $Villains$Types.SetView($Villains$Types.PenguinView),_1: "Penguin"}])))]));
   });
   return _elm.Villains.View.values = {_op: _op,root: root,modal: modal};
};
Elm.View = Elm.View || {};
Elm.View.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Heroes$View = Elm.Heroes.View.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $Types = Elm.Types.make(_elm),
   $Villains$View = Elm.Villains.View.make(_elm),
   $Viscose = Elm.Viscose.make(_elm);
   var _op = {};
   var root = F2(function (address,model) {
      var villainsAddress = A2($Signal.forwardTo,address,$Types.VillainsAction);
      var heroesAddress = A2($Signal.forwardTo,address,$Types.HeroesAction);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("container-fluid")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("row")]),
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("col-md-6")]),_U.list([A2($Heroes$View.root,heroesAddress,model.heroes)]))
                      ,A2($Html.div,_U.list([$Html$Attributes.$class("col-md-6")]),_U.list([A2($Villains$View.root,villainsAddress,model.villains)]))]))
              ,$Viscose.root($Maybe.oneOf(_U.list([A2($Heroes$View.modal,heroesAddress,model.heroes)
                                                  ,A2($Villains$View.modal,villainsAddress,model.villains)])))]));
   });
